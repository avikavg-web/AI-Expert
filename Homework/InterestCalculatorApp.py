...
lbl_header = tk.Label(root,text="Interest Calculator", font=("Arial", 16, "bold"), bg="White", fg="Black",)
lbl_header.grid(row=0, column=0, columnspan=2, pady=20)

lbl_principal = tk.Label(root, text="Principal ($):", font=("Arial", 11), bg="#f4f6f9", anchor="e")
...
lbl_time = tk.Label(root, text="Time (Years):", font=("Arial", 11), bg="#f4f6f9", anchor="e")
...
lbl_rate = tk.Label(root, text="Rate of Interest (%):", font=("Arial", 11), bg="#f4f6f9", anchor="e")
...
btn_calculate = tk.Button(root,text="Calculate",font=("Arial", 11, "bold"),bg="Green",fg="white",activebackground="Blue",
activeforeground="white",padx=10,pady=5,command=calculate_interest,)
btn_calculate.grid(row=4, column=0, columnspan=2, pady=20)

lbl_si_text = tk.Label( root, text="Simple Interest:", font=("Arial", 11, "bold"), bg="Blue", anchor="e",)
lbl_si_text.grid(row=5, column=0, sticky="ew", padx=20, pady=8)
lbl_si_result = tk.Label(root, text="$0.00", font=("Arial", 11, "bold"), bg="#f4f6f9", fg="Purple")
lbl_si_result.grid(row=5, column=1, sticky="w", padx=20, pady=8)

lbl_ci_text = tk.Label(root, text="Compound Interest:", font=("Arial", 11, "bold"), bg="Red", anchor="e",)
lbl_ci_text.grid(row=6, column=0, sticky="ew", padx=20, pady=8)
lbl_ci_result = tk.Label( root, text="$0.00", font=("Arial", 11, "bold"), bg="White", fg="Blue")
